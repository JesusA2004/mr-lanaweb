...
// =========================================================
// Vacantes (mismo patrón que ya usas)
// =========================================================
...
// =========================================================
// Modal solicitud (lo dejamos por si lo conectas)
// =========================================================
...
// =========================================================
// Créditos (puedes cambiar nombres/condiciones si Crédito Comadres tiene otros)
// =========================================================
const creditSpecs = {
  crece12: {
...
const creditTabs = computed<SegmentTabItem[]>(() => [
  ...
  { key: 'crece8q', label: 'Comadres 8Q', iconSrc: creditSpecs.crece8q.icon, iconAlt: creditSpecs.crece8q.alt },
  { key: 'crece12q', label: 'Comadres 12Q', iconSrc: creditSpecs.crece12q.icon, iconAlt: creditSpecs.crece12q.alt },
])

const currentCredit = computed(() => creditSpecs[activeCredit.value])

// =========================================================
// Pasos Crédito Comadres (tu texto)
// =========================================================
const steps = [
  {
...
<template>
  <Head title="Crédito Comadres | Mr Lana" />
  <PublicLayout>
    <!-- MODAL -->
    <BusinessLoanRequestModal
      :open="openModal"
      :branches="branches"
      context="credito-comadres"
    ...
    <div class="relative w-full overflow-hidden">
      ...
      <div class="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div class="text-center text-white px-4">
          <h1 class="text-3xl sm:text-4xl md:text-6xl font-extrabold [text-shadow:_0_2px_10px_rgb(0_0_0_/_85%)]">
            CRÉDITO COMADRES
          </h1>
          <p class="mt-2 text-lg sm:text-xl md:text-3xl font-bold [text-shadow:_0_2px_10px_rgb(0_0_0_/_85%)]">
          ...
          <div class="mx-auto max-w-[820px] text-center pointer-events-auto">
            <button
              ...
              class="inline-flex w-full sm:w-auto items-center justify-center
                     ...
                     transition hover:bg-white/20 hover:scale-[1.01] active:scale-[0.99]"
            >
              Solicitar ahora
            </button>
          </div>
    ...
    <div class="bg-zinc-950 py-10 sm:py-12 px-4 overflow-hidden">
      <div class="max-w-7xl mx-auto">
        <div class="text-center mb-10">
          <h2 class="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white uppercase tracking-tight">
            PASOS CRÉDITO COMADRES
          </h2>
          <p class="mt-2 text-white/70 text-sm sm:text-base">
            Flujo claro, sin fricción. Tu asesora te guía en cada fase.
          </p>
        </div>
    ...
    <!-- ===================== BLOQUE “QUIÉNES SOMOS” (lo dejas si quieres) ===================== -->
              ...
              <div class="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-10 xl:gap-12 items-center">
                  <div class="text-center lg:text-left">
                    <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-white">
                      CRÉDITO COMADRES
                    </h2>
                  </div>
                  ...
                  <div>
                    <p class="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-white">
                      Crédito grupal diseñado para mujeres que se apoyan entre sí. Un esquema claro, acompañado por tu asesor,
                      para impulsar tus proyectos de forma rápida y sencilla.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div class="max-w-7xl mx-auto">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-6 lg:gap-8 items-start">
                <div class="flex items-center justify-center lg:justify-start">
                  <img
                    ...
                    class="h-28 w-28 sm:h-32 sm:w-32 md:h-36 md:w-36 lg:h-44 lg:w-44"
                  />
                </div>
        ...
        <div class="text-center mt-12">
          ...
          <button
            type="button"
            @click="openWhatsApp"
            class="px-8 py-4 bg-gradient-to-r from-green-500 to-sky-500 text-white font-extrabold text-lg sm:text-xl rounded-full
                   hover:opacity-95 transition flex items-center justify-center mx-auto gap-3
                   shadow-[0_18px_60px_-35px_rgba(16,185,129,0.55)]"
          >
        ...
        <Container>
          <div class="flex flex-col items-center justify-center text-center">
            <button
              ...
              class="bg-white text-green-600 hover:bg-green-50 px-6 py-3 text-base font-extrabold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
      ...
      >
        <Container>
          <div class="flex flex-col items-center justify-center text-center">
            <button
              @click="handleOpenVacancies()"
              class="bg-white text-green-600 hover:bg-green-50 px-8 py-4 lg:px-12 lg:py-6 xl:px-16 xl:py-8 text-lg lg:text-xl xl:text-2xl font-extrabold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
