            ...
            <div class="absolute inset-0 z-10 flex items-end justify-center">
                <div class="w-full px-4 pb-5 sm:pb-6 md:pb-7">
                    <div class="mx-auto max-w-[760px] text-center pointer-events-auto">
                        ...
                        bg-black/70 px-6 sm:w-[180px] md:w-[230px] lg:w-[300px] xl:w-[340px]
                        ...
                        font-extrabold text-white shadow-lg ring-1 ring-white/15 transition
        ...
        <section class="bg-white px-4 py-10 sm:py-12 md:py-14 lg:py-16 overflow-hidden">
            <div class="mx-auto max-w-7xl">
                ...
                <div class="grid gap-4 sm:gap-5 md:gap-6" style="grid-template-columns: repeat(auto-fit, minmax(240px, 1fr));">
                    ...
                    class="group relative rounded-2xl bg-teal-300/5 ring-teal-300/5
                    ring-1 p-5 sm:p-6 shadow-[0_20px_60px_-45px_rgba(0,0,0,0.9)]
                    transition duration-300 hover:-translate-y-1 hover:bg-white/[0.08]
        ...
        <div class="py-16 px-4 bg-gray-50">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="text-center mt-12">
                    ...
                    class="px-8 py-4 bg-gradient-to-r from-green-500 to-blue-500
                    text-white font-bold text-xl rounded-full hover:opacity-90 transition
