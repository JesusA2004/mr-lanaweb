<script setup lang="ts">
    ...
    <template>
      <footer class="relative overflow-hidden bg-[#d9d9d9] text-slate-900">
        <!-- =========================================================
          MOBILE / MEDIO (NO lo cambio: tal cual lo pediste)
        ========================================================== -->
        <div class="lg:hidden md:block xl:hidden 2xl:hidden">
          ...
          <div class="relative overflow-hidden">
            <img
              ...
              alt="Mr. Lana"
              class="block w-full h-auto max-w-none"
              loading="lazy"
            />
          </div>
          ...
          <div class="relative mx-auto max-w-7xl px-5 pt-5 pb-12">
            <div class="grid grid-cols-2 gap-5">
              ...
              <section class="min-w-0">
                ...
                <a
                  href="tel:7774225973"
                  class="mt-1 inline-flex items-center gap-2 text-sm font-semibold text-emerald-700 transition hover:text-emerald-800"
                >
                  <img
                    src="/img/icons/icon-phone.png"
                    alt="Teléfono"
                ...
                <a
                  href="mailto:atencionclientes@mr-lana.com"
                  class="mt-1 inline-flex text-sm font-semibold text-slate-900 underline decoration-transparent underline-offset-4 transition hover:text-teal-700 hover:decoration-teal-500"
                >
            ...
            <div class="pointer-events-none absolute bottom-2 right-2">
              <div class="relative w-[92px] opacity-95">
                <img
                  src="/img/footer/bg-whaticket-mobile.png"
                  alt="Asistente"
        ...
        <!-- =========================================================
          DESKTOP (LG+)
          Objetivo:
          - NO mover porcentajes
          - En 1053px (lg) NO tapar texto con logo degree
          - Quitar el copyright de desktop (como pediste)
          - Mejor distribución: lg más compacto, xl/2xl más grande
        ========================================================== -->
        <div class="hidden lg:block">
          <!-- BG degree (MISMO porcentaje) -->
          <div class="absolute inset-y-0 left-0 w-[60%] xl:w-[50%] 2xl:w-[55%]">
            <img
              src="/img/footer/footer-degree.png"
              alt="Mr. Lana"
            ...
            <!-- Esto NO mueve porcentajes: solo evita que el logo “muerda” el texto -->
            <div
              class="pointer-events-none absolute inset-y-0 right-0
                     w-40 xl:w-32 2xl:w-28
                     bg-gradient-to-r from-transparent to-[#d9d9d9]"
            />
            <!-- Scrim extra (LG only): suaviza aún más el borde cuando hay poco ancho -->
            <div
              class="pointer-events-none absolute inset-y-0 right-0
                     w-56 xl:w-0
                     bg-gradient-to-r from-transparent via-[#d9d9d9]/70 to-[#d9d9d9]"
            />
          </div>
          ...
          <div class="relative z-10 mx-auto max-w-7xl px-8 py-9 lg:pl-[46%] xl:pl-[42%] 2xl:pl-[39%]">
            <!-- Distribución: en LG hacemos 2 columnas reales (6/6) y show compacto,
                 en XL/2XL damos aire con tipografía mayor -->
            <div class="grid grid-cols-12 gap-10 xl:gap-12 2xl:gap-14">
              <!-- Contacto -->
              <section class="col-span-6 min-w-0">
                <p class="text-[11px] font-extrabold tracking-[0.18em] text-slate-600 xl:text-xs">
                  MR-LANA
                </p>
    
                <!-- LG más chico para que quepa; XL/2XL más grande -->
                <h3
                  class="mt-2 font-black tracking-tight text-slate-950
                         text-[20px] lg:text-[20px]
                         xl:text-[28px] 2xl:text-[34px]"
                >
                  Contáctanos
                </h3>
                ...
                <div
                  class="mt-5 space-y-3 leading-relaxed
                ...
                >
                  <div>
                    ...
                    <a
                      href="tel:7774225973"
                      class="group mt-2 inline-flex items-center gap-2 font-semibold text-emerald-700 transition hover:text-emerald-800"
                    >
                      <img
                        src="/img/icons/icon-phone.png"
                        alt="Teléfono"
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:atencionclientes@mr-lana.com"
                      class="mt-2 inline-flex font-semibold text-slate-900 underline decoration-transparent underline-offset-4 transition hover:text-teal-700 hover:decoration-teal-500 break-words"
                    >
                      atencionclientes@mr-lana.com
                    </a>
                  </div>
              ...
              <aside class="col-span-12 flex justify-end pt-2">
                <div class="relative w-[260px] xl:w-[320px] 2xl:w-[360px]">
                  <img
                    src="/img/footer/bg-whabutton.png"
                    alt="Asistente"
                    class="w-full drop-shadow-sm"
                    loading="lazy"
                  />
            ...
            <!-- IMPORTANTE:
              - En DESKTOP ya NO pongo el copyright (como pediste).
              - No meto textos extra.
            -->
          </div>
        </div>
      </footer>
