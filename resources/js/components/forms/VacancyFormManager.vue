<!-- resources/js/components/vacancies/VacancyFormManager.vue -->
...
import { useVacancyManager } from '@/composables/useVacancyManager'
...
const {
  ...
  sending,
  submit,
} = useVacancyManager('/api/vacantes/gerente')
              ...
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    maxlength="10"
                    class="mt-1 w-full rounded-2xl bg-slate-100/70 px-4 py-3 text-slate-900 ring-1 ring-black/5 outline-none
                           transition hover:ring-black/10 focus:ring-2 focus:ring-emerald-400/60 text-[13px] sm:text-[14px] md:text-[15px]"
            ...
            <section class="rounded-3xl bg-slate-50 ring-1 ring-black/5 p-4 sm:p-5">
              ...
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <div class="mt-2 flex items-center gap-4 text-[13px] sm:text-[14px]">
                    <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                      <input v-model="form.liderazgo" type="radio" value="si" name="liderazgo" class="h-4 w-4 accent-emerald-500"
                             @change="clearAlerts(); clearFieldError('liderazgo')" />
                      <span class="font-semibold">Sí</span>
                    </label>
                    <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                      <input v-model="form.liderazgo" type="radio" value="no" name="liderazgo" class="h-4 w-4 accent-emerald-500"
                             @change="clearAlerts(); clearFieldError('liderazgo')" />
                ...
                <div>
                  ...
                  <div
                    v-if="hasCv"
                    class="mt-3 flex items-center justify-between gap-3 rounded-2xl bg-white/70 ring-1 ring-black/5 px-4 py-3 shadow-sm"
                  >
                    <div class="min-w-0">
                    ...
                    <button
                      type="button"
                      class="grid h-9 w-9 place-items-center rounded-full bg-slate-900 text-white transition hover:bg-slate-800 disabled:opacity-60"
                      :disabled="sending"
                      @click="removeCv"
          ...
          <div class="mt-4 space-y-4 text-[13px] sm:text-[14px]">
            ...
            <div class="rounded-2xl bg-slate-50 ring-1 ring-black/5 p-4">
              ...
              <div class="mt-2 flex items-center gap-4">
                <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                  <input v-model="form.p1_cartera" type="radio" value="si" name="p1_cartera" class="h-4 w-4 accent-emerald-500"
                         @change="clearAlerts(); clearFieldError('p1_cartera')" />
                  <span class="font-semibold">Sí</span>
                </label>
                <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                  <input v-model="form.p1_cartera" type="radio" value="no" name="p1_cartera" class="h-4 w-4 accent-emerald-500"
                         @change="clearAlerts(); clearFieldError('p1_cartera')" />
                  <span class="font-semibold">No</span>
                </label>
              </div>
            ...
            <div class="rounded-2xl bg-slate-50 ring-1 ring-black/5 p-4" :class="blockedByP1 ? 'opacity-55 pointer-events-none' : ''">
              ...
              <div class="mt-2 flex items-center gap-4">
                <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                  <input v-model="form.p2_campo" type="radio" value="si" name="p2_campo" class="h-4 w-4 accent-emerald-500"
                         @change="clearFieldError('p2_campo')" />
                  <span class="font-semibold">Sí</span>
                </label>
                <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                  <input v-model="form.p2_campo" type="radio" value="no" name="p2_campo" class="h-4 w-4 accent-emerald-500"
                         @change="clearFieldError('p2_campo')" />
                  <span class="font-semibold">No</span>
                </label>
              </div>
            ...
            <div class="rounded-2xl bg-slate-50 ring-1 ring-black/5 p-4" :class="blockedByP1 ? 'opacity-55 pointer-events-none' : ''">
              ...
              <div class="mt-2 flex items-center gap-4">
                <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                  <input v-model="form.p3_indicadores" type="radio" value="si" name="p3_indicadores" class="h-4 w-4 accent-emerald-500"
                         @change="clearFieldError('p3_indicadores')" />
                  <span class="font-semibold">Sí</span>
                </label>
                <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                  <input v-model="form.p3_indicadores" type="radio" value="no" name="p3_indicadores" class="h-4 w-4 accent-emerald-500"
                         @change="clearFieldError('p3_indicadores')" />
                  <span class="font-semibold">No</span>
                </label>
              </div>
            ...
            <div class="rounded-2xl bg-slate-50 ring-1 ring-black/5 p-4" :class="blockedByP1 ? 'opacity-55 pointer-events-none' : ''">
              ...
              <div class="mt-2 space-y-2">
                <label class="flex items-center gap-2 cursor-pointer select-none">
                  <input v-model="form.p4_accion" type="radio" value="analizo" name="p4_accion" class="h-4 w-4 accent-emerald-500"
                         @change="clearFieldError('p4_accion')" />
                  <span class="font-semibold">Analizas indicadores y corriges con el equipo</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer select-none">
                  <input v-model="form.p4_accion" type="radio" value="reporteo" name="p4_accion" class="h-4 w-4 accent-emerald-500"
                         @change="clearFieldError('p4_accion')" />
                  <span class="font-semibold">Reportas y esperas indicaciones</span>
                </label>
                <label class="flex items-center gap-2 cursor-pointer select-none">
                  <input v-model="form.p4_accion" type="radio" value="presiono" name="p4_accion" class="h-4 w-4 accent-emerald-500"
                         @change="clearFieldError('p4_accion')" />
            ...
            <div class="rounded-2xl bg-slate-50 ring-1 ring-black/5 p-4" :class="blockedByP1 ? 'opacity-55 pointer-events-none' : ''">
              ...
              <div class="mt-2 flex items-center gap-4">
                <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                  <input v-model="form.p5_presion" type="radio" value="si" name="p5_presion" class="h-4 w-4 accent-emerald-500"
                         @change="clearFieldError('p5_presion')" />
                  <span class="font-semibold">Sí</span>
                </label>
                <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                  <input v-model="form.p5_presion" type="radio" value="no" name="p5_presion" class="h-4 w-4 accent-emerald-500"
                         @change="clearFieldError('p5_presion')" />
                  <span class="font-semibold">No</span>
                </label>
              </div>
