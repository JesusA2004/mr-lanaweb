      ...
      <div class="w-full bg-white">
        <div class="relative w-full">
          <div class="relative h-[210px] sm:h-[230px] md:h-[250px] lg:h-[270px] xl:h-[290px] 2xl:h-[310px]">
            <img :src="bgSrc" alt="Vacante Gerente" class="absolute inset-0 h-full w-full object-cover object-center" loading="lazy" draggable="false" />
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
              <div class="space-y-4">
                ...
                <div>
                  ...
                  <input placeholder="usuario@dominio.com" v-model="form.correo" type="email" class="mt-1 w-full rounded-2xl bg-slate-100/70 px-4 py-3 text-slate-900 ring-1 ring-black/5 outline-none transition hover:ring-black/10 focus:ring-2 focus:ring-emerald-400/60 text-[13px] sm:text-[14px] md:text-[15px]" @input="clearAlerts" />
              ...
              <div class="space-y-4">
                ...
                <NumericInput v-model="form.experiencia_anios" label="Años de experiencia" placeholder="Solo números" :error="errors.experiencia_anios" @update:modelValue="clearAlerts" />
                ...
                <div>
                  ...
                  <div class="mt-2 flex items-center gap-4 text-[13px] sm:text-[14px]">
                    <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                      <input v-model="form.liderazgo" type="radio" value="si" name="liderazgo" class="h-4 w-4 accent-emerald-500" @change="clearAlerts" />
                      <span class="font-semibold">Sí</span>
                    </label>
                    <label class="inline-flex items-center gap-2 cursor-pointer select-none">
                      <input v-model="form.liderazgo" type="radio" value="no" name="liderazgo" class="h-4 w-4 accent-emerald-500" @change="clearAlerts" />
