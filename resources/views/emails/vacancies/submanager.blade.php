  ...
  <div style="max-width:720px;margin:0 auto;padding:24px;">
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:14px;overflow:hidden;">
      <div style="padding:18px 20px;background:#0b67a3;color:#fff;">
        ...
        <div style="font-size:20px;font-weight:800;margin-top:4px;">Postulación: Subgerente</div>
      </div>
      ...
      <div style="padding:20px;">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          ...
          <tr><td style="padding:8px 0;color:#6b7280;">Escolaridad</td><td style="padding:8px 0;">{{ $data['escolaridad'] ?? '' }}</td></tr>
          <tr><td style="padding:8px 0;color:#6b7280;">Paquetería Office</td><td style="padding:8px 0;">{{ $data['office'] ?? '' }}</td></tr>
          <tr><td style="padding:8px 0;color:#6b7280;">Años de experiencia</td><td style="padding:8px 0;">{{ $data['experiencia_anios'] ?? '' }}</td></tr>
          <tr><td style="padding:8px 0;color:#6b7280;">Liderazgo</td><td style="padding:8px 0;">{{ ($data['liderazgo'] ?? '') === 'si' ? 'Sí' : 'No' }}</td></tr>
        </table>
        ...
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          <tr><td style="padding:8px 0;color:#6b7280;width:220px;">Responsable de metas</td><td style="padding:8px 0;">{{ ($data['p_responsable_meta'] ?? '') === 'si' ? 'Sí' : (($data['p_responsable_meta'] ?? '') === 'no' ? 'No' : '') }}</td></tr>
          <tr><td style="padding:8px 0;color:#6b7280;">Disponibilidad campo</td><td style="padding:8px 0;">{{ ($data['p_disponibilidad_campo'] ?? '') === 'si' ? 'Sí' : (($data['p_disponibilidad_campo'] ?? '') === 'no' ? 'No' : '') }}</td></tr>
        </table>
