  ...
  <div style="max-width:720px;margin:0 auto;padding:24px;">
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:14px;overflow:hidden;">
      <div style="padding:18px 20px;background:#0b67a3;color:#fff;">
        ...
        <div style="font-size:20px;font-weight:800;margin-top:4px;">Postulación: Coordinadora</div>
      </div>
      ...
      <div style="padding:20px;">
        ...
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          ...
          <tr><td style="padding:8px 0;color:#6b7280;">Fecha de nacimiento</td><td style="padding:8px 0;">{{ $data['fecha_nacimiento'] ?? '' }}</td></tr>
