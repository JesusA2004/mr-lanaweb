<!doctype html>
    <html lang="es">
        ...
        <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
            Se recibió una postulación para Coordinadora de Sucursal.
        </div>
                                ...
                                style="background:#ffffff;border-radius:30px;overflow:hidden;border:1px solid #e6f6f5;box-shadow:0 18px 60px rgba(15,23,42,.10);">
                                    ...
                                    <tr>
                                        <td style="padding:0;background:#062a2a;">
                                            ...
                                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                ...
                                                <!-- Candidate spotlight (circular + big text) -->
                                                <tr>
                                    ...
                                    <tr>
                                        <td style="padding:18px 18px 20px 18px;">
                                            ...
                                            <!-- Pills / compact cards (less spacing + round) -->
                                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                <tr>
                                                    <td style="padding:0;">
                                                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <tr>
                                                                ...
                                                                <td width="50%" style="padding-left:6px;vertical-align:top;">
                                                                    ...
                                                                    style="background:#f3fffd;border:1px solid #c8f3ed;border-radius:999px;">
                                                                        <tr>
                                                                            <td style="padding:10px 14px;">
                                                                                <div style="font-size:11px;color:#0f766e;font-weight:1000;letter-spacing:.08em;text-transform:uppercase;">Sucursal de interés</div>
